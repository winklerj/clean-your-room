Study @${PLAN_FILE} thoroughly.

Use HTN planning and implement the next incomplete task ready to be implemented from the task list.
...
Focus on ONE task. AVOID compaction at all costs. Make the code production-ready and optimize coherent expected value.
